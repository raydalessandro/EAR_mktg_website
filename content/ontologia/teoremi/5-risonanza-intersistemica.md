...
download:
  file: /downloads/ontologia/teoremi/5_PROPOSIZIONE_RISONANZA_INTERSISTEMICA.md
  format: md
related:
...
È il **quinto pilastro formale** di EAR e quello che applica i pilastri precedenti all'interazione fra sistemi. Deriva direttamente dal Trattato (Libro III, Capp. IX-XII) e poggia su quattro proposizioni: Campo C ([Prop. 1](/ontologia/teoremi/1-minimo-osservazionale)), conservazione informazionale ([Prop. 2](/ontologia/teoremi/2-conservazione-informazionale)), soglia critica ([Prop. 3](/ontologia/teoremi/3-soglia-critica)), e scaling ([Prop. 4](/ontologia/teoremi/4-scaling-dimensionale)) per l'invarianza fra scale.

Il punto chiave è ontologico: le quattro fasi sono *co-presenti*, non sequenziali. La formula operativa R = Θ(Porta)·Θ(Spirale)·Θ(Nodo)·Θ(Seme) è proiezione misurabile, non descrizione della realtà. Dominanza osservata di una fase non implica assenza delle altre — analogia: RGB è proiezione operativa, ma il colore percepito è sintesi simultanea. Si lega esplicitamente alla [Prop. 6](/ontologia/teoremi/6-inseparabilita-attributi): le 4 fasi sono manifestazioni dei 3 attributi (Δ/⇄/⟳) più l'integrazione del Seme.
...
- Pairing con [AILA Kernel](/ontologia/aila/sistema-formale/kernel) (P5) e con la [Prop. 6](/ontologia/teoremi/6-inseparabilita-attributi) per la mappa fasi → attributi.
